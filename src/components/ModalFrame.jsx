...
export default function ModalFrame({
  ...
  return (
    <div className={`tv-backdrop fixed inset-0 z-50 flex items-end justify-center p-2 backdrop-blur-md sm:items-center sm:p-4 ${backdropClassName}`.trim()}>
      <div className={`tv-surface tv-text pointer-events-auto relative flex max-h-[calc(100dvh-1rem)] w-full ${maxWidthClassName} flex-col overflow-hidden rounded-2xl transition-all duration-200 ease-out sm:max-h-[calc(100dvh-2rem)] sm:rounded-2xl animate-in fade-in zoom-in-95 slide-in-from-bottom-4 sm:slide-in-from-center-0 ${panelClassName}`}>
